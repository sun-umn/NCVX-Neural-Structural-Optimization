...
def structural_optimization_function(X_struct,z,freedofs_forces, ke, args, designs, kwargs, new_index_map,u,K):
    """
...
designs = []
comb_fn = lambda X_struct: structural_optimization_function(
    X_struct, fixed_random_input, freedofs_forces, ke, args, designs, kwargs, new_index_map, u, K
)

var_in = {"x_phys": [20,60],"u": [2562,1]}

# var_in = {"u": [2562,1]}
# opts.x0 = u.reshape(-1,1)
