...
def structural_optimization_task(problem_name, num_trials, maxit, resizes):
    ...
    run = neptune.init_run(
        project="liang664/TO-PyGRANSO",
        api_token="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiI1MjNiMmU1ZC00OWU5LTRlMzMtYmM4MS01YTA3OTc0NzYxNDcifQ==",
    )
